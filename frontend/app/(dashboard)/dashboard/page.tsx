...
import { KpiCard, Card, CardHeader, Table, Th, Td, Tr, PaymentBadge, Avatar, Badge, ProgressBar, Empty, Skeleton } from '@/components/ui'
  ...
  <div className="page-container fade-up" style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
    ...
    <div style={{
      ...
      <Card className="fade-up">
        <CardHeader
          action={
            <a href="/payments?status=overdue" className="link">
              Voir tout →
            </a>
          }
        >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <Card className="fade-up">
          ...
          <div style={{ padding: 16 }}>
            ...
            {!groups?.length && <Empty message="Aucun groupe actif" />}
          </div>
        </Card>
